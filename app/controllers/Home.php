...
class Home extends Controller
{
    ...
    public function index(): void
    {
        ...
        if ($action && $action === 'consultar') {
            ...
            Depois do diagnóstico e das sugestões escreva uma carta, informal, baseada no diálogo de uma relacionamento de $ageMarried anos, para o $spouse1Name enviar para o $spouse2Name com a intenção de melhorar o relacionamento e sugerindo melhoras baseado nas suas observações.
            Formate o texto de forma que fique legível, colocando cada tópico em uma linha e dando um espaço entre elas. A carta deve estar formatada e pronta pra copiar e colar, inclusive com os nomes da esposa ou marido remetente bem como do destinatário.
            "
                    ]
                ]
            );
