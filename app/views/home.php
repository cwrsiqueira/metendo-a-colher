    ...
    <div class="container-fluid">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#">
                <img src="<?= URL; ?>public/assets/img/logo.webp" alt="Logo" width="80" height="80" class="d-inline-block align-text-top">
...
<div class="container p-3">
    ...
    <div class="description mt-3 row">
        <div class="col-lg fw-semibold">
            <p>Seja bem-vindo!</p>
            <p>Utilizamos inteligência artificial para dar conselhos matrimoniais e sugerir uma carta para ser enviada ao seu cônjuge. Melhore seu relacionamento com a ajuda de inteligência artificial.</p>
            <p>Preencha o formulário abaixo e clique Enviar para ver o resultado.</p>
            <p>Experimente gratuitamente!</p>
            <p class="fw-bold text-danger">Não se preocupe, este site não usa cookies nem armazena nenhum dado ou informação do usuário. Todas as informações coletadas são utilizadas somente para gerar os resultados necessários e descartadas em seguida.</p>
        </div>
        <div class="col-lg text-center">
            <div class="text-center p-4 mt-4 fw-semibold">Considere ser um patrocinador com qualquer valor e ajude a manter o site sempre GRATUITO!</div>

            <button class="border border-secondary py-2 px-4 rounded bg-dark text-white fs-6 fw-semibold">
                <a href="https://www.mercadopago.com.br/subscriptions/checkout?preapproval_plan_id=2c9380848eed4752018eedb8ca7f0039" target="_blank" class='d-flex align-items-center text-white text-decoration-none'>
    ...
    <?php if (empty($success)) : ?>
        ...
        <form method="post" class="mt-3 needs-validation" id="form" novalidate>
            ...
            <div class="row">
                ...
                <div class="col-lg form-group">
                    <label for="focus" class="form-label">8. Pra você, quais são os objetivos do casamento <br> <small>(Até 5 palavras)</small></label>
            ...
            <div class="row">
                <div class="col-lg">
                    <label for="mainproblem" class="form-label">9. Descrição do problema <br> <small>(Quanto mais informações e mais precisas forem, melhores serão o diagnóstico e as sugestões da Inteligência Artificial)</small></label>
            ...
            <div class="row">
                <div class="col-lg">
                    <label for="one" class="form-label">10. Se você fosse resumir todos os problemas do seu relacionamento em até 5 palavras, quais palavras você usaria? <small>(Até 5 palavras)</small></label>
                ...
                <div class="col-lg">
                    <div class="col-lg form-group">
                        <label for="obs" class="form-label">11. Alguma outra informação importante?<br> <small>(Se tiver, altere o texto abaixo)</small></label>
...
<nav class="navbar bg-light navbar-expand-lg">
    <div class="container-fluid">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#">
                <img src="<?= URL; ?>public/assets/img/logo.webp"
                    alt="Logomarca Metendo a Colher | Um casal dentro de uma colher dentro de um coração" width="80"
                    height="80" class="d-inline-block align-text-top">
                <div class="d-flex flex-column ms-3">
                    <h1 class="display-6 fw-bolder">Metendo a Colher</h1>
                    <small class="text-dark">Conselhos Matrimoniais</small>
                </div>
            </a>
        </div>
...
<footer class="footer">
    <p>&copy; 2024 Metendo a Colher - Todos os direitos reservados.</p>
>>>>>>> 2b94bd294afc749fff2754a91730e761b28b9daa
</footer>