    ...
    <div class="container-fluid">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#">
                <img src="<?= URL; ?>public/assets/img/logo.webp" alt="Logomarca Metendo a Colher | Um casal dentro de uma colher dentro de um coração" width="80" height="80" class="d-inline-block align-text-top">
